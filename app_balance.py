...
from balance_engine import SymmetryAnalyzer # 假设上面的类保存在此文件中

st.set_page_config(page_title="视觉平衡分析仪", layout="wide", page_icon="⚖️")
...
if uploaded_file:
    ...
    with col2:
        ...
        # 核心评分
        st.metric("📏 距离对称性评分", f"{result.score} / 100", 
                  delta="完美对称" if result.score > 90 else None)
